...
class Batcher(object):
    ...
    def __init__(self, data_path, vocab, mode, batch_size, single_pass):
        ...
        self._batch_queue = Queue.Queue(self.BATCH_QUEUE_MAX)  # Queue of batches
        self._example_queue = Queue.Queue(self.BATCH_QUEUE_MAX * self.batch_size)  # Queue of examples
